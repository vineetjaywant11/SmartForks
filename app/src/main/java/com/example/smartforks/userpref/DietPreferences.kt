...
import com.example.smartforks.model.DietPref
...
@Composable
fun DietPreferences(onNext: () -> Unit) {
    ...
    Column(
        ...
        Column(
            ...
            Text(text = "Do you follow any of these diets?", fontSize = 24.sp)
            ...
            Column(
                ...
                FlowRow(
                    ...
                    DietPref.entries.forEach { diet ->
                        DietChip(
                            text = diet.dietPref,
                            selected = isSelectedItem(diet.dietPref),
                            onSelected = { onChangeState(diet.dietPref) })
                    }
                }
                Spacer(modifier = Modifier.size(36.dp))
                OutlinedTextField(
